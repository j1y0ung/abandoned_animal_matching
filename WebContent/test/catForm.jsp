        ...
        <div id="l-margin">
            ...
            <form method="POST" name="form" action="<c:url value='/test/score' />">
                ...
                <c:forEach var="catTest" items="${catTestList}">
                	...
                	<input type="radio" name="test${i}_@i" value="2">${catTest.catQ_2} <br>
                	<input type="radio" name="test${i}_@i" value="3">${catTest.catQ_3} <br>
                	<input type="radio" name="test${i}_@i" value="4">${catTest.catQ_4} <br><br>
