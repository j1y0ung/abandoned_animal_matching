...
<%@ page import="model.dao.SearchingDAO,model.dao.SearchingDTO" %>
...
<head>
	...
	<link rel=stylesheet href="<c:url value='/css/final_search_css.css' />" type="text/css">
    ...
    function goSearch() {
    	...
    	f.method = 'post';
    	//f.action = '/teamProject/test/main';
    	f.submit();
    } 
    ...
    function goDetailPage(kind, age, careAddr, careNm, careTel, chargeNm, colorCd, desertionNo, filename, happenDt, happenPlace, kindCd, neuterYn, noticeEdt, noticeNo, noticeSdt, officetel, orgNm, popfile, processState, sexCd, specialMark, weight) {
    	...
    	f.method = 'post';
    	f.action = '/teamProject/search';	// 주소 파싱할 api 호출 
    	f.submit();
    }
    </script>
